  ...
  <!--   Optional JS   -->
  <script src="<?php echo base_url('assets/argon/js/plugins/chart.js/dist/Chart.min.js')?>"></script>
  <script src="<?php echo base_url('assets/argon/js/plugins/chart.js/dist/Chart.extension.js')?>"></script>
  <!--   Argon JS   -->
